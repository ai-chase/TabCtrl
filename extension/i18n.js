...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'settings.page_subtitle':         'Customize how your Home page looks and behaves. All settings save instantly.',
      'settings.back_link':             'Back to Home',
      'settings.back_tooltip':          'Open Home page',
    ...
    zh: {
      ...
      'settings.page_subtitle':         '自定义主页的外观与行为。所有设置即时保存。',
      'settings.back_link':             '返回主页',
      'settings.back_tooltip':          '打开主页',
